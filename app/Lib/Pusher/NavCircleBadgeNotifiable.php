...
{
    protected function setChannelName(int $teamId = 0, int $userId = 0)
    {
        $this->channelName = "user_" . $userId . "_team_" . $teamId;
    }
    ...
    public function build(PostEntity $post = null, int $circleId = 0, int $userId = 0)
    {
        $this->setChannelName($post['team_id'], $userId);
        $this->setEventName();
