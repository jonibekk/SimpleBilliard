...
class PaymentTiming 
{
    ...
    /*
     * check if this user has alread been charged
     *
     */
    public function checkUserAlreadyCharged(int $inviteCreatedTime, int $teamId): bool 
    {
        /* get payment flag */
        $redisClient = new PaymentFlagClient();
        $switchFlagKey = new PaymentFlagKey(PaymentFlagKey::SWITCH_FLAG_NAME);
        ...
        if (PaymentFlagClient::isAfterPeriod($inviteCreatedTime, $paymentBaseDay, $switchStartDate, $teamId)) {
            return true;
        }
        return false;
    }
