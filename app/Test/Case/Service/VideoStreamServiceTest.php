...
class VideoStreamServiceTest extends GoalousTestCase
{
    ...
    function test_isVideoStreamBelongsToTeam()
    {
        ...
        $this->assertTrue($this->VideoStreamService->isVideoStreamBelongsToTeam($videoStream1['id'], 1));
        $this->assertFalse($this->VideoStreamService->isVideoStreamBelongsToTeam($videoStream1['id'], 2));
        $this->assertFalse($this->VideoStreamService->isVideoStreamBelongsToTeam($videoStream2['id'], 1));
        $this->assertTrue($this->VideoStreamService->isVideoStreamBelongsToTeam($videoStream2['id'], 2));
        $this->assertFalse($this->VideoStreamService->isVideoStreamBelongsToTeam($videoStream1['id'], 99999));
