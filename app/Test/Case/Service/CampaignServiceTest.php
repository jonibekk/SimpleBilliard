...
class CampaignServiceTest extends GoalousTestCase
{
    ...
    {
        $this->createCampaignTeam($createTeamId = 1, $campaignType = 0, $pricePlanGroupId = 1);// Plan Group of JPY
        $this->assertTrue($this->CampaignService->isAllowedPricePlan($teamId = 1, $pricePlanId, $companyCountry));

        $this->createCampaignTeam($createTeamId = 2, $campaignType = 0, $pricePlanGroupId = 2);// Plan Group of USD
    ...
    {
        $this->createCampaignTeam($createTeamId = 1, $campaignType = 0, $pricePlanGroupId = 2);// Plan Group of USD
        $this->assertTrue($this->CampaignService->isAllowedPricePlan($teamId = 1, $pricePlanId, $companyCountry));

        $this->createCampaignTeam($createTeamId = 2, $campaignType = 0, $pricePlanGroupId = 1);// Plan Group of JPY
        $this->assertFalse($this->CampaignService->isAllowedPricePlan($teamId = 2, $pricePlanId, $companyCountry));
    }
