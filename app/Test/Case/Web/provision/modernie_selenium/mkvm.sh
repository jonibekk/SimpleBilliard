...
set_network_config() {
  ...
  log "Setting network hostonlyadapter"
  execute "VBoxManage modifyvm \"${vm_name}\" --nic2 \"hostonly\" --hostonlyadapter2 \"vboxnet1\""
...
setup_language() {
  log "setup language"
  execute "VBoxManage guestcontrol \"${vm_name}\" execute --image \"Start-Process powershell.exe -Verb runas\" --username 'IEUser' --password 'Passw0rd!' -- \"% Set-WinUserLanguageList ja-JP, en-US -Force\""
  # "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
  # execute "VBoxManage guestcontrol \"${vm_name}\" execute --image \"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe\" --username 'IEUser' --password 'Passw0rd!' -- \"% Set-WinUserLanguageList ja-JP, en-US -Force\""
}
