 ...
 */
class ActionResultFileFixture extends CakeTestFixture
{
    ...
    public $fields = array(
        ...
        'action_result_id' => array('type' => 'biginteger', 'default' => null, 'unsigned' => true, 'key' => 'index', 'comment' => 'アクションID(belongsToでActionResultモデルに関連)'),
