 ...
 */
class PostSharedLogFixture extends CakeTestFixture
{
    ...
    public $fields = array(
        ...
        'user_id'         => array('type' => 'biginteger', 'default' => null, 'unsigned' => true, 'key' => 'index', 'comment' => '共有ユーザを追加した人のID(belongsToでUserモデルに関連)'),
