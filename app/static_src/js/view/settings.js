        ...
        */
        calendarInit:function(){
            this.calendar.currentStart.setMonth(
                parseInt(document.getElementById("currentStart").getAttribute("data-date").substring(5,7))-1
            );
            this.calendar.currentStart.setYear(
                document.getElementById("currentStart").getAttribute("data-date").substring(0,3)
            );
            this.startUpdate();
        },
        ...
        startUpdate:function(){
            this.calendar.nextStart.setMonth(
                parseInt(document.getElementById("term_start").value.substring(5,7))-1
            );
            this.calendar.nextStart.setYear(
                parseInt(document.getElementById("term_start").value.substring(0,3))
            );
