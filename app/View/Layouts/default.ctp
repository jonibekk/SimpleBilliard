...
<div id="container" class="container">
    <div class="<?= $is_mb_app ? "hidden" : "col-md-2 col-sm-4 col-xs-4 hidden-xxs" ?> layout-sub">
        <div class="<?=$my_teams?null:'hidden' ?> left-side-container" id="jsLeftSideContainer">
    ...
    <div id="jsRightSideContainerWrap"
         class="<?=$my_teams?null:'hidden' ?> right-side-container-wrap <?= $is_mb_app ? "col-md-12 hidden" : "col-md-4 visible-md visible-lg col-xs-8 col-xxs-12" ?> layout-goal"
         role="goal_area">
