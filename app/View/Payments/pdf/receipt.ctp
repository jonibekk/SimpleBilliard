...
<article id="pdfReceipt">
    <header>
        ...
        <?php if ($history['PaymentSetting']['is_card']): ?>
            <?php if ($history['ChargeHistory']['result_type'] == Goalous\Enum\ChargeHistory\ResultType::SUCCESS): ?>
    ...
    <div class="invoice-table">
        <?php
            ...
            switch ($history['ChargeHistory']['charge_type']) {
                case Goalous\Enum\ChargeHistory\ChargeType::MONTHLY_FEE:
                    $type = __("Monthly");
                    break;
                case  Goalous\Enum\ChargeHistory\ChargeType::USER_INCREMENT_FEE:
                case Goalous\Enum\ChargeHistory\ChargeType::USER_ACTIVATION_FEE:
                    $type = __('Add member(s)');
                    break;
                case Goalous\Enum\ChargeHistory\ChargeType::UPGRADE_PLAN_DIFF:
                    $type = __('Upgrade');
                    break;
                case Goalous\Enum\ChargeHistory\ChargeType::RECHARGE:
                    $type = __('Recharge');
                    break;
            }
        ...
        <table>
            <?php
                $label = "";
                $val = "";
                $isRecharge = $history['ChargeHistory']['charge_type'] == Goalous\Enum\ChargeHistory\ChargeType::RECHARGE;
                if ($isMonthly) {
