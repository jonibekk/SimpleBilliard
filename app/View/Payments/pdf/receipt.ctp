<article id="pdfReceipt">
    ...
    <div class="invoice-contact">
        <address>
            ISAO Corporation <br /><br />
            5-20-8 Asakusabashi CS Tower, 7th Floor<br />
            Taito-ku, Tokyo 111-0053 Japan
        </address>
        <footer>
            This is only for your records, no payment is due. If you have any questions, please contact us at contact@goalous.com. Thank you for your business!
        </footer>
    </div>
</article>