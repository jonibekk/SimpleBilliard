...
<section class="panel company-info paymentMethod">
    ...
    <form class="form-horizontal" name="" id="" accept-charset="utf-8">
        <div class="form-group">
            ...
            <input
                type="text" id="PaymentsCompanyName" name="company_name" value="" required class="form-control"
        ...
        <fieldset class="company-info-fieldset">
            ...
            <div class="form-group">
                <label for="PaymentsCompanyPostCode" class="circle-create-label">Post
                    Code</label>
                <input type="tel" id="PaymentsCompanyPostCode" name="company_post_code" value="" required
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       name="company_region" value="" required
                       class="form-control"
                       placeholder="東京都"
                       maxlength="255">
            </div>
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       name="company_city" value="" required
                       class="form-control"
            ...
            <div class="form-group">
                ...
                <div class="flex">
                    <input type="text" id="PaymentsContactPersonLastName" name="contact_person_last_name"
                           value="" required class="form-control   mr_8px" placeholder="例) 鈴木">
                    <input type="text"
            ...
            <div class="form-group">
                ...
                <div class="flex">
                    <input type="text" id="PaymentsContactPersonLastNameKana"
                           name="contact_person_last_name_kana" value="" required class="form-control   mr_8px"
                           placeholder="スズキ">
                    <input type="text" id="PaymentsContactPersonFirstNameKana"
                           name="contact_person_first_name_kana" value="" required
        ...
        <div class="form-group">
            ...
            <input
                type="email" id="PaymentsContactPersonEmail" name="contact_person_email" value="" required class="form-control"
