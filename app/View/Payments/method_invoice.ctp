    ...
    <form class="form-horizontal" name="editInvoiceForm" id="editInvoiceForm" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="flex">
                    <input type="text" id="PaymentsContactPersonLastNameKana"
                           name="contact_person_last_name_kana" value="<?= $invoice['contact_person_last_name_kana'] ?>"
                    ...
                    <input type="text" id="PaymentsContactPersonFirstNameKana"
                           ...
                           value="<?= $invoice['contact_person_first_name_kana'] ?>" required
        ...
        <div class="form-group">
            ...
            <input
                    ...
                    value="<?= $invoice['contact_person_email'] ?>" required
                    class="form-control"
