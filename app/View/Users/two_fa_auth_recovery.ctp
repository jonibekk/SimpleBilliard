...
<div class="row">
    <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading"><?= __d('gl', "リカバリーコードを入力する") ?></div>
            <div class="panel-body login-panel-body">
                ...
                <p class="mb_12px"><?= __d('gl', "アカウントにログインできない場合は、リカバリーコードを使用してログインできます。") ?></p>
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        <?=
                        $this->Form->submit(__d('gl', "コードを送信"), ['class' => 'btn btn-primary']) ?>
                    </div>
                </div>
                <?= $this->Form->end(); ?>
            </div>
