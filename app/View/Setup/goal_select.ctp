      ...
      <div class="setup-items">
        ...
        <a class="setup-items-item pt_10px mt_12px bd-radius_14px" href="/setup/goal_create">
          ...
          <div class="setup-items-item-explain pull-left">
            <p class="font_bold font_verydark"><?= __("Talk with team members") ?></p>
          </div>
        ...
        <a class="setup-items-item pt_10px mt_12px bd-radius_14px" href="/setup/goal_create">
          ...
          <div class="setup-items-item-explain pull-left">
            <p class="font_bold font_verydark"><?= __("Lunch with team members") ?></p>
          </div>
          <div class="setup-items-item-to-right pull-right mt_12px mr_5px">
            <i class="fa fa-chevron-right font_18px"></i>
          </div>
        ...
        <a class="setup-items-item pt_10px mt_12px bd-radius_14px" href="/setup/goal_create">
          ...
          <div class="setup-items-item-explain pull-left">
            <p class="font_bold font_verydark"><?= __("Hear complaints of team members") ?></p>
          </div>
          <div class="setup-items-item-to-right pull-right mt_12px mr_5px">
            <i class="fa fa-chevron-right font_18px"></i>
          </div>
