                        ...
                        <?php 
                            ...
                            foreach ($kr_select_options as $krID => $krName){ ?>
                                ...
                                <?php elseif($krName == "All"): ?>
                                    <li><a href="/goals/view_actions/goal_id:<?php echo $goal_id ?>/page_type:<?php echo $this->request->params['named']['page_type'] ?>/"><?php echo $krName ?></a></li>
                                <?php else: ?> 
                                    <li><a href="/goals/view_actions/goal_id:<?php echo $goal_id ?>/page_type:<?php echo $this->request->params['named']['page_type'] ?>/key_result_id:<?php echo $krID ?>"><?php echo $krName ?></a></li>
                                <?php endif; ?> 
                        <?php   }
                            unset($krName);
                            unset($krID);
