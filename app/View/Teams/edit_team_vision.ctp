 ...
 */
?>
<!-- START app/View/Teams/edit_team_vision.ctp -->
<div class="row">
    <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading"><?= __d('gl', "チームビジョンを更新") ?></div>
            <?=
                    ...
                    <div class="col col-sm-6">
                        <div class="fileinput_small fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail nailthumb-container photo-design"
                                ...
                                <?=
                                $this->Upload->uploadImage($this->request->data, 'TeamVision.photo',
                                                           ['style' => 'x_large']) ?>
                            </div>
                            <div>
            ...
            <div class="panel-footer addteam_pannel-footer">
                <div class="row">
                    <div class="team-button pull-right">
                        <?=
                        $this->Form->submit(__d('gl', "チームビジョンを更新する"),
...
<?php $this->end() ?>
<!-- END app/View/Teams/edit_team_vision.ctp -->
