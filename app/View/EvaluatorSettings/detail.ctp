...
<div class="panel panel-default col-sm-8 col-sm-offset-2 clearfix eval-list">
            ...
            <li class="list-group-item row eval-list-item p_5px plr_11px">
                ...
                <div class="col-xxs-9 pr_12px vertical-center horizontal-center">
                    <input type="hidden" class="form-input evaluator_select"
                           ...
                           data-default-text="<?= sprintf("%s (%s)", $userEvaluator['User']['display_username'],
                               $userEvaluator['User']['roman_username']) ?>"
                           data-default-image="<?= $this->Upload->uploadUrl($userEvaluator, 'User.photo',
                               ['style' => 'medium']) ?>"
                    />
                </div>
    ...
    <div class="panel-body row">
        ...
        <div class="col-xxs-10 vertical-center">
            <p id="button_add_evaluator" class="font_bold color-blue pointer">+ <?= __('Add evaluator') ?><span
                        id="remaining_to_add" class="p_5px font_normal font_lightgray"></span></p>
        </div>
    </div>
    <div class="panel-body addteam_pannel-footer">
        <div class="row">
            <div class="team-button pull-right">
                <a class="btn btn-link design-cancel bd-radius_4px" data-dismiss="modal" href="<?= $this->Html->url([
