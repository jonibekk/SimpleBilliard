            ...
            <div class="container text-center">
                ...
                <form class="signup-form">
                    <div class="form-group">
                        ...
                        <input type="email" id="semail1" name="semail1" class="form-control" placeholder="メールアドレスを入力">
                    </div>
                    <button type="submit" class="btn btn-cta btn-cta-primary">新規登録</button><p class="under-mail"><a href="">利用規約</a>をご確認のうえ、同意いただけましたら「新規登録」ボタンを押してください。</p>
                </form><!--//signup-form-->
            </div><!--//contianer-->
        </div><!--//signup-->
        <div class="social text-center">
            <div class="container">
                ...
                <div class="hatena-bookmark">
                    <a href="http://b.hatena.ne.jp/entry/http://www.goalous.com/" class="hatena-bookmark-button" data-hatena-bookmark-title="Goalous ニッポンの仕事を変える、チーム力向上ツール" data-hatena-bookmark-layout="simple-balloon" title="このエントリーをはてなブックマークに追加"><img src="https://b.st-hatena.com/images/entry-button/button-only@2x.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="https://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
    ...
    <div class="container text-center">
        <div class="row">
            <ul class="list-unstyled">
                <li class="col-md-2 col-sm-4 col-xs-6"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-1.png" alt=""></a></li>
                <li class="col-md-2 col-sm-4 col-xs-6"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-2.png" alt=""></a></li>
                <li class="col-md-2 col-sm-4 col-xs-6 xs-break"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-3.png" alt=""></a></li>
                <li class="col-md-2 col-sm-4 col-xs-6 sm-break"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-4.png" alt=""></a></li>
                <li class="col-md-2 col-sm-4 col-xs-6 xs-break"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-5.png" alt=""></a></li>
                <li class="col-md-2 col-sm-4 col-xs-6"><a href="/Goalous_lp_mock/company-content.html"><img class="img-responsive" src="/img/homepage/press/press-6.png" alt=""></a></li>
            </ul>
        </div>
    </div>
</div><!--//press-->
    ...
    <div class="container text-center">
        ...
        <form class="signup-form" method="post" action="#">
            <div class="form-group">
                ...
                <input type="email" id="semail2" name="semail2" class="form-control" placeholder="メールアドレスを入力する" required>
            </div>
