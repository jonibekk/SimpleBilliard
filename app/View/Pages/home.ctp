...
$meta_lp = [
    ...
    [
        "property" => "og:title",
        "content" => __d('app', 'Goalous(ゴーラス) | 最強にオープンな社内SNS'),
    ],
    [
        "property" => "og:description",
        "content" =>__d('app', 'Goalous (ゴーラス) は、ゴール達成への最強にオープンな社内SNS。すべてのメンバーのゴールをオープンにし、ゴールへのアクションを写真でたのしく共有できます。スマホアプリ・ブラウザで利用可能です。'),
    ],
    [
        "property" => "og:url",
