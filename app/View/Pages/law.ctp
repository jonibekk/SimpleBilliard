...
$meta_law = [
    ...
    [
        "property" => "og:title",
        "content" => __d\('app', '特定商取引法に基づく表記 | Goalous(ゴーラス)'),
    ],
    [
        "property" => "og:description",
        "content" =>__d\('app', 'Goalous (ゴーラス) は、ゴール達成への最強にオープンな社内SNS。すべてのメンバーのゴールをオープンにし、ゴールへのアクションを写真でたのしく共有できます。特定商取引法に基づく表記はこちら。'),
    ],
    [
        "property" => "og:url",
