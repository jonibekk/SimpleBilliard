...
<div class="modal-dialog" id="RecoveryCodeModal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= __d('gl', "リカバリーコード") ?></h4>
        </div>
        <div class="modal-body">
            <div class="two_fa_step_box">
                <?= __d('gl', 'これらのコードを印刷するか書き留めて、安全な場所に保管しましょう。各リカバリーコードは１回のみ使用できます。') ?>
            </div>
            ...
            <hr>
            <?= $this->Html->link(__d('gl', "新しいリカバリーコードを作成"), '#', [
                'class' => 'regenerate-recovery-code'
            ]) ?>
            <div class="font_11px">
                <?= __d('gl', '新しいリカバリーコードを生成すると、上記のリカバリーコードは全て無効になります。') ?>
            </div>
