    ...
    <?php else: ?>
        ...
        <div class="panel-body user-setting-panel-body">
            ...
            <?php if (!empty($team_can_translate)): ?>
                <?= $this->Form->input('TeamMember.0.default_translation_language', [
                    'label'     => __("Translation Language"),
                    'type'      => 'select',
                    'default'   => $default_translation_language,
                    'options'   => $translation_languages,
                    'wrapInput' => 'col col-sm-6 user-setting-lang-select-wrap'
                ]) ?>
                <div class="form-group">
                    <div class="col col-sm-3 control-label form-label"></div>
                    <div class="user-setting-lang-select-wrap col col-sm-6"><span
                                class="help-block inline-block font_11px"><?= __('Translation language is set in each team') ?></span>
                    </div>
                </div>
            <hr>
            <?php endif ?>
