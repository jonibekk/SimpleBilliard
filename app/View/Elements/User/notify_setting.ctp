        ...
        <div class="panel-body notify-setting-panel-body">
            <div class="form-group">
                <label class="col col-sm-3 col-xxs-12 control-label form-label">
                    <i class="fa fa-globe"></i> <?= __d('gl', 'Goalousサイト') ?>
                </label>
            ...
            <div class="form-group">
                <label class="col col-sm-3 col-xxs-12 control-label form-label">
                    <i class="fa fa-envelope-o"></i> <?= __d('gl', 'Email') ?>
                </label>
                <?=
            ...
            <div class="form-group">
                <label class="col col-sm-3 col-xxs-12 control-label form-label">
                    <i class="fa fa-mobile"></i> <?= __d('gl', 'モバイル') ?>
                </label>
                <?=
...
<script>
    $(function () {
        var notify_help_message = {
            'all': '<?= __d('gl', 'すべての通知が送信されます。') ?>',
            'primary': '<?= __d('gl', 'あなたに関わる重要な通知（サークルへの新しい投稿などを除く）が送信されます。') ?>',
            'none': '<?= __d('gl', '通知は送信されません。') ?>'
        };
