    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group"><label for="" class="modal-label pr_12px"></label>
                ...
                <div class="aaa">
                    <p class="form-control-static"><?= __("現在、2段階認証が有効になっています。") ?></p>

                    <p class="form-control-static"><?= __("2段階認証を解除しますか？") ?></p>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <?= $this->Form->postButton(__("解除する"), ['controller' => 'users', 'action' => 'delete_2fa'],
