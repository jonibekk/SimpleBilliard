...
<footer class="footer <?= $is_mb_app ? 'hide' : null ?>">
            ...
            <div class="row">
                <div class="footer-col col-md-5 col-sm-7 col-sm-12 about">
                    <div class="footer-col-inner">
                        ...
                        <p>
                            ...
                            <?= __d('lp', '2015年10月1日（木）より、日本初のバリフラットモデルを導入し、管理職０（ゼロ）、階層０（ナシ）、 チーム力∞（無限大）の組織運営をおこなっています。') ?>
                        </p>
                        <p><a class="more" href="http://www.isao.co.jp/" target="_blank"><?= __d('lp', 'HPを見る ') ?><i class="fa fa-long-arrow-right"></i></a></p>
                ...
                <div class="footer-col col-md-3 col-sm-12 contact">
                    <div class="footer-col-inner">
                        ...
                        <div class="row">
                            <p class="email col-md-12 col-sm-4"><i class="fa fa-envelope"></i><a href="/contact.html"><?= __d('lp', 'お問い合わせ') ?></a></p>
                            <p class="email col-md-12 col-sm-4"><i class="fa fa-microphone"></i><a href="/contact.html"><?= __d('lp', 'プレス関連のお問い合わせ') ?></a></p>
                            <p class="email col-md-12 col-sm-4"><i class="fa fa-heart"></i><a href="/contact.html"><?= __d('lp', '協業のお問い合わせ') ?></a></p>
                        </div>
                    </div>
                </div>
            </div><!--//footer-col-inner-->
    ...
    <div class="bottom-bar">
        <div class="container">
            <div class="row">
                <small class="copyright col-md-6 col-sm-6 col-xs-12"><?= __d('lp', '© 2016 ISAO │　English (US)  　日本語') ?></small>
