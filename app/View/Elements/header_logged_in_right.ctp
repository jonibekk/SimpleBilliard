...
<div class="header-right-navigations clearfix">
    ...
    <div class="header-dropdown-functions header-function">
        ...
        <ul class="header-nav-function-contents dropdown-menu " role="menu"
            ...
            <li>
                <a href="javascript:void(0)" data-uv-lightbox="classic_widget" data-uv-mode="full" data-uv-primary-color="#fff" data-uv-link-color="#007dbf" data-uv-default-mode="feedback" data-uv-forum-id="196840">フィードバック
                </a>
            </li>
        </ul>
    </div>
