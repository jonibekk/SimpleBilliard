                    ...
                    <?php if (strtolower($this->Session->read('ua.device_type')) === "desktop" && !$is_mb_app): ?>
                        <li>
                            <a href="<?= $this->Html->url(
                                ...
                                <i class="fa fa-download"></i><?= __("ダウンロード") ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if ($this->Upload->isCanPreview($data)): ?>
                        <li>
                            <a href="<?= $this->Upload->attachedFileUrl($data, "viewer") ?>"
                                ...
                                <i class="fa fa-external-link-square"></i><?= __("プレビュー") ?></a>
                        </li>
                    <?php endif; ?>
                    <li>
                        <a href="<?= $this->Html->url(['controller' => 'posts', 'action' => 'feed', 'post_id' => $post_id]) ?>">
                            <i class="fa fa-eye"></i><?= __("投稿を見る") ?></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row file-btn-group">
                <?php if ($this->Upload->isCanPreview($data)): ?>
                    <a class="link-dark-gray" href="<?= $this->Upload->attachedFileUrl($data, "viewer") ?>"
                        ...
                        <div class="col col-xxs-6 text-center file-btn-wap">
                            <div class="file-btn">
                                <i class="fa fa-external-link-square"></i><?= __("プレビュー") ?>
                            </div>
                        </div>
                    </a>
                <?php else: ?>
                ...
                <?php if (strtolower($this->Session->read('ua.device_type')) === "desktop" && !$is_mb_app): ?>
                    <a class="link-dark-gray" href="<?= $this->Html->url(
                        ...
                        <div class="col col-xxs-6 text-center file-btn-wap">
                            <div class="file-btn">
                                <i class="fa fa-download"></i><?= __("ダウンロード") ?>
                            </div>
                        </div>
                    </a>
                <?php endif; ?>
