...
elseif (isset($this->request->params['post_id']) && !empty($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],"/users/view_actions/") !== false): ?>
    <a href="#"
...
elseif (isset($this->request->params['post_id']) && !empty($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],"/goals/view_actions/") !== false): ?>
    <a href="#"
