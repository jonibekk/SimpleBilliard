...
<div
    class="col feed-contents post-contents <?= viaIsSet($long_text) ? "showmore-circle" : "showmore" ?> font_14px font_verydark box-align <?= $mentions = $this->Mention->isMentioned($post['Post']['body'], $my_id, $my_team_id) ? "mentioned" : "" ?>"
