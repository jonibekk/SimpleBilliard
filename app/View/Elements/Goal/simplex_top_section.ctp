...
<div class="panel-body goal-detail-upper-panel">
    ...
    <div class="goal-detail-button-wrap col-sm-9 col-xs-10 col-xxs-9 mt_18px">
        ...
        <?php else: ?>
                ...
                <div class="col col-xxs-5 col-xxs-offset-1">
    ...
    <div class="goal-detail-more-details-wrap col-sm-3 col-xs-2 col-xxs-3">
...
<div class="goal-detail-tab-group">
    ...
    <a class="col-xxs-2 col-xxs-offset-1 goal-detail-member-tab <?= ($this->request->params['action'] == 'view_members') || ($this->request->params['action'] == 'view_followers')  ? "goal-details-tab-active" : null ?>"
       href="<?= $this->Html->url(
           [
               'controller' => 'goals',
               'action'     => 'view_members',
