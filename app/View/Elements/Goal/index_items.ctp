            ...
            <? if ($goal['Goal']['user_id'] != $this->Session->read('Auth.User.id') && isset($goal['Goal'])): ?>
                <div class="col col-xxs-12 mt_5px">
                    ...
                    <div class="col col-xxs-6 col-xs-4 mr_5px">
                        <a class="btn btn-white font_verydark-white bd-circle_20 toggle-follow p_8px <?= $follow_class ?>"
                           href="#"
                    ...
                    <div class="col col-xxs-5 col-xs-4">
                        <a class="btn btn-white bd-circle_20 font_verydark-white modal-ajax-get-collabo p_8px <?= $collabo_class ?>"
                           data-toggle="modal"
