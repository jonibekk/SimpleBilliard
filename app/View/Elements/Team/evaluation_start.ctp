...
<div class="panel panel-default">
    <div class="panel-heading"><?= __("評価開始") ?></div>
    <div class="panel-body form-horizontal">
        <div class="form-group">
            <label for="TeamName" class="col col-sm-3 control-label form-label"></label>

            <div class="col col-sm-6">
                <p class="form-control-static"><?= __("このセクションでは、現在の評価設定に基づき、評価を開始できます。") ?></p>

                <p class="form-control-static"><?= __("この設定は取り消すことができませんので気を付けてください。") ?></p>
            </div>
        </div>
        <div class="form-group">
            <label for="TeamName" class="col col-sm-3 control-label form-label"><?= __("今期の期間") ?></label>
        ...
        <?php if (!$eval_enabled): ?>
            <div class="alert alert-danger" role="alert">
                <?= __("現在、評価設定が有効では無い為、評価を開始する事ができません。") ?>
            </div>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                    <?=
                    $this->Form->postLink(__("今期の評価を開始する"),
                                          ['controller' => 'teams', 'action' => 'start_evaluation',],
                                          ['class' => 'btn btn-primary'], __("取り消しができません。よろしいですか？")) ?>
                </div>
            </div>
        </div>
    <?php endif; ?>
