...
<div class="panel panel-default">
    <div class="panel-heading"><?= __("期間設定") ?></div>
    <?=
    ...
    <div class="panel-body add-team-panel-body">
        ...
        <div class="form-group">
            <label class="col col-sm-3 control-label form-label"><?= __('変更適用対象') ?></label>
            ...
            <div class="col col-sm-6">
                ...
                ?>
                <?php if ($disabled): ?>
                    <span class="help-block font_11px"><?= __("評価期間中は今期の変更ができません。") ?></span>
                <?php endif; ?>
            </div>
        </div>
        <?=
        ...
        <?php if ($previous_term_start_date && $previous_term_end_date): ?>
            <div class="form-group">
                <label class="col col-sm-3 control-label form-label"><?= __("前期の期間") ?></label>
        ...
        <?php if ($current_term_start_date && $current_term_end_date): ?>
            <div class="form-group">
                <label class="col col-sm-3 control-label form-label"><?= __("現在の今期の期間") ?></label>
        ...
        <?php if ($next_term_start_date && $next_term_end_date): ?>
            <div class="form-group">
                <label class="col col-sm-3 control-label form-label"><?= __("現在の来期の期間") ?></label>
        ...
        <div class="form-group none" id="NewCurrentTerm">
            <label class="col col-sm-3 control-label form-label"><?= __("更新後の今期の期間") ?></label>
        ...
        <div class="form-group none" id="NewNextTerm">
            <label class="col col-sm-3 control-label form-label"><?= __("更新後の来期の期間") ?></label>
