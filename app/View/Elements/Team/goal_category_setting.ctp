...
<div class="panel panel-default">
    <div class="panel-heading"><?= __("ゴールカテゴリ設定") ?></div>
    <div class="panel-body form-horizontal">
        ...
        <div class="form-group">
            ...
            $max_index = $index + 9; ?>
            <?= $this->Html->link(__("ゴールカテゴリを１つ追加"),
                                  ...
                                  <?= $this->Form->submit(__('ゴールカテゴリ設定を保存'), ['class' => 'btn btn-primary team-setting-add-goal-category']) ?>
        </div>
