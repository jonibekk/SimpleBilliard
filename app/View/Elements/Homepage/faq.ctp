...
なお、弊社はプライバシーマークの取得企業ですのでご安心ください。')
        ...
        [
            ...
            'answer' => __d('lp', 'Androidフォン, iPhoneの専用アプリケーションをご用意しております。それぞれのストアからダウンロードしてご利用ください。スマートフォンやタブレットからブラウザでアクセスいただいても、最適化されたビューでご利用できます。')
        ],
        [
        ...
        [
            'question' => __d('lp', '2016年8月31日の無料期間の後はどうなりますか？'),
            'answer' => __d('lp', 'ぜひぜひ！お問い合わせフォームからご連絡くださいませ。お待ちしております。')
        ],
        [
        ...
        [
            ...
            'answer' => __d('lp', '2016年8月31日までの無料キャンペーン中にご登録いただいたお客様には、ログイン後に利用できるサポートツールでお問い合わせください。できる限り早い対応をいたします。')
        ],
        [
