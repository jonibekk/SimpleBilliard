...
<li id="<?= $circle['id']?>" class="justify-content-between pin-circle-list-item">
	...
	<a href="#" class="fa-pull-right-pin-circle-cog pin-circle-dropdown-element ajax-url" data-url="/circles/ajax_get_edit_modal/circle_id:<?php echo $circle['id']; ?>"><i class="fa fa-cog fa-2x pin-circle-cog"></i></a>
	<?php else :?>
	...
	<?php endif; ?>
	<i class="fa-pull-right-less fa fa-thumb-tack fa-2x a-black-link"></i>
</li>
