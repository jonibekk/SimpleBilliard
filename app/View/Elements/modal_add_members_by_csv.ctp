    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= __("新しいメンバーを追加") ?></h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class=""><?= __("1.テンプレートをダウンロード") ?></label>

                    <p><?= __("CSVフォーマットのテンプレートをダウンロードしてください。テンプレートのヘッダーは変更しないでください。") ?></p>

                    <div class="">
                        <?=
                        $this->Html->link(__("テンプレートをダウンロード"), ['action' => 'download_add_members_csv_format'],
                ...
                <div class="form-group">
                    ...
                    <p><?= __("新しいメンバーを追加したファイルをアップロードしてください。") ?></p>
