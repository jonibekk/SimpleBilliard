                        ...
                        <div class="panel-body comment-block">
                            <?= $this->Form->create('GoalApproval',
                                [
                                    ...
                                    'url'        => ['controller' => 'goal_approval', 'action' => 'index'],
                                    'type'       => 'post',
                                    'novalidate' => true
                                ]); ?>
                                ...
                                <div class="approval_botton_area">
                                    <?php if ($goal['my_goal'] === false) { ?>
                                        ...
                                        <?= $this->Form->button(__("Remove from target of evaluation"),
                                            [
                                                'name'     => 'wait_btn',
                                                'id'       => 'reject_btn_' . $goal['GoalMember']['id'],
                                                'class'    => 'btn btn-Gray approval_button',
                                                'div'      => false,
                                                'disabled' => 'disabled'
                                            ]) ?>
                                    <?php } elseif ($goal['my_goal'] === true && $goal['GoalMember']['type'] === (string)GoalMember::TYPE_OWNER && $goal['GoalMember']['approval_status'] === (string)GoalMember::APPROVAL_STATUS_WITHDRAWN) { ?>
                            ...
                            <div class="form-group">
                                <?= $this->Form->textarea('comment',
                                    [
                                        ...
                                        'target-id'                    => 'modify_btn_' . $goal['GoalMember']['id'] . ',' . 'reject_btn_' . $goal['GoalMember']['id'],
                                        'rows'                         => 3,
                                        'cols'                         => 30,
                            ...
                            <div class="row">
                                <div class="approval_botton_area">
                                    <?php if ($goal['my_goal'] === true || ($goal['my_goal'] === false && $goal['GoalMember']['type'] === (string)GoalMember::TYPE_COLLABORATOR)) { ?>
                                    ...
                                    <?php } else { ?>
                                        <?= $this->Form->button(__("Request to modify."),
                                            [
                                                'id'       => 'modify_btn_' . $goal['GoalMember']['id'],
                                                'name'     => 'modify_btn',
                                                'class'    => 'btn btn-Gray approval_button',
                                                'div'      => false,
                                                'disabled' => 'disabled'
