...
class ChangeAllEmailFlgToDefaultZeroOnNotifySettings0624 extends CakeMigration
{
     ...
     * @var string
     */
    public $description = 'change_all_email_flg_to_default_zero_on_notify_settings_0624';
