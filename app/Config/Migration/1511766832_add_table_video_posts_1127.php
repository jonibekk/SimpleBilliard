<?php
class AddTableVideoPosts1127 extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'add_table_video_posts_1127';
		...
		'up' => array(
			'create_table' => array(
				...
				'video_streams' => array(
					...
					'master_playlist_path' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 1024, 'collate' => 'utf8mb4_general_ci', 'comment' => 'cloud storage stored key', 'charset' => 'utf8mb4'),
