<?php
class AddMessages0818 extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'add_messages_0818';
		...
		'up' => array(
			'create_table' => array(
				'messages' => array(
					...
					'created' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => true, 'key' => 'index'),
