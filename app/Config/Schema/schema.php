...
class AppSchema extends CakeSchema
{
    ...
    public $action_result_files = array(
        ...
        'action_result_id' => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'アクションID(belongsToでActionResultモデルに関連)'
        ),
    ...
    public $approval_histories = array(
        ...
        'goal_member_id'          => array(
            'type'     => 'biginteger',
            'null'     => false,
            'default'  => null,
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'ゴールメンバーID(hasManyでcollaboratorモデルに関連)'
        ),
        'user_id'                 => array(
            'type'     => 'biginteger',
            'null'     => false,
    ...
    public $attached_files = array(
        ...
        'file_type'             => array(
            ...
            'default'  => '0',
            'unsigned' => true,
            'comment'  => 'ファイルタイプ(0:画像,1:ビデオ,2:ドキュメント)'
        ),
        'file_ext'              => array(
            'type'    => 'string',
            'null'    => true,
        ...
        'model_type'            => array(
            ...
            'default'  => '0',
            'unsigned' => true,
            'comment'  => 'モデルタイプ(0:Post,1:Comment)'
        ),
        'display_file_list_flg' => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'ファイル一覧に表示するフラグ'
        ),
        'removable_flg'         => array(
            'type'    => 'boolean',
            'null'    => false,
    ...
    public $comment_mentions = array(
        ...
        'user_id'         => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'メンションユーザID(belongsToでUserモデルに関連)'
        ),
        'team_id'         => array(
            'type'     => 'biginteger',
            'null'     => false,
    ...
    public $devices = array(
        ...
        'indexes'         => array(
            ...
            'device_token'    => array(
                'column' => 'device_token',
                'unique' => 0,
                'length' => array('device_token' => '191')
            ),
            'installation_id' => array(
                'column' => 'installation_id',
                'unique' => 0,
                'length' => array('installation_id' => '191')
            )
        ),
        'tableParameters' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_general_ci', 'engine' => 'InnoDB')
    );
    ...
    public $evaluation_settings = array(
        ...
        'self_goal_score_flg'                 => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価ゴールスコア on/off'
        ),
        'self_goal_score_required_flg'        => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価ゴールスコア必須 on/off'
        ),
        'self_goal_comment_flg'               => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 ゴール コメント on/off'
        ),
        'self_goal_comment_required_flg'      => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 ゴール コメント必須 on/off'
        ),
        'self_score_flg'                      => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 トータル スコア on/off'
        ),
        'self_score_required_flg'             => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 トータル スコア 必須 on/off'
        ),
        'self_comment_flg'                    => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 トータル コメント on/off'
        ),
        'self_comment_required_flg'           => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '自己評価 トータル コメント 必須 on/off'
        ),
        'evaluator_flg'                       => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 on/off'
        ),
        'evaluator_goal_score_flg'            => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 ゴール スコア on/off'
        ),
        'evaluator_goal_score_reuqired_flg'   => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 ゴール スコア必須 on/off'
        ),
        'evaluator_goal_comment_flg'          => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 ゴール コメント on/off'
        ),
        'evaluator_goal_comment_required_flg' => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 ゴール コメント必須 on/off'
        ),
        'evaluator_score_flg'                 => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 トータル スコア on/off'
        ),
        'evaluator_score_required_flg'        => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 トータル スコア 必須 on/off'
        ),
        'evaluator_comment_flg'               => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 トータル コメント on/off'
        ),
        'evaluator_comment_required_flg'      => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '評価者評価 トータル コメント 必須 on/off'
        ),
        'final_flg'                           => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '最終評価者評価 on/off'
        ),
        'final_score_flg'                     => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '最終評価者評価 トータル スコア on/off'
        ),
        'final_score_required_flg'            => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '最終評価者評価 トータル スコア 必須 on/off'
        ),
        'final_comment_flg'                   => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '最終評価者評価 トータル コメント on/off'
        ),
        'final_comment_required_flg'          => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => '最終評価者評価 トータル コメント 必須 on/off'
        ),
        'leader_flg'                          => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'リーダ評価 on/off'
        ),
        'leader_goal_score_flg'               => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'リーダ評価 ゴール スコア on/off'
        ),
        'leader_goal_score_reuqired_flg'      => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'リーダ評価 ゴール スコア必須 on/off'
        ),
        'leader_goal_comment_flg'             => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'リーダ評価 ゴール コメント on/off'
        ),
        'leader_goal_comment_required_flg'    => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
    ...
    public $given_badges = array(
        ...
        'user_id'         => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'バッジ所有ユーザID(belongsToでUserモデルに関連)'
        ),
        'grant_user_id'   => array(
            'type'     => 'biginteger',
            'null'     => false,
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'バッジあげたユーザID(belongsToでUserモデルに関連)'
        ),
        'team_id'         => array(
            'type'     => 'biginteger',
            'null'     => false,
        ...
        'post_id'         => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => '投稿ID(hasOneでPostモデルに関連)'
        ),
        'del_flg'         => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => '削除フラグ'),
        'deleted'         => array(
            'type'     => 'integer',
    ...
    public $member_types = array(
        ...
        'description'     => array(
            ...
            'default' => null,
            'collate' => 'utf8mb4_general_ci',
            'comment' => 'タイプの説明(正規雇用で企業に雇われた労働者等',
            'charset' => 'utf8mb4'
        ),
        'active_flg'      => array(
            'type'    => 'boolean',
    ...
    public $message_files = array(
        ...
        'message_id'       => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'MessageID(belongsTo Message Model)'
        ),
        'attached_file_id' => array(
            'type'     => 'biginteger',
            'null'     => false,
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'AttachedFileID(belongsTo AttachedFile Model)'
        ),
        'team_id'          => array(
            'type'     => 'biginteger',
            'null'     => false,
    ...
    public $messages = array(
        ...
        'target_user_ids_if_member_changed' => array(
            'type'    => 'string',
            'null'    => true,
            'default' => null,
            'collate' => 'utf8mb4_general_ci',
    ...
    public $notify_settings = array(
        ...
        'setup_guide_app_flg'                              => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'セットアップガイドからのアプリ通知'
        ),
        'setup_guide_email_flg'                            => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'セットアップガイドからのメール通知'
        ),
        'setup_guide_mobile_flg'                           => array(
            'type'    => 'boolean',
            'null'    => false,
            'default' => '1',
            'comment' => 'セットアップガイドからのモバイル通知'
        ),
        'del_flg'                                          => array(
            'type'    => 'boolean',
            'null'    => false,
    ...
    public $topic_members = array(
        ...
        'last_seen_message_id' => array(
            ...
            'default'  => null,
            'unsigned' => true,
            'comment'  => 'message_id as last seen'
        ),
        'del_flg'              => array('type' => 'boolean', 'null' => false, 'default' => '0'),
        'deleted'              => array('type' => 'integer', 'null' => true, 'default' => null, 'unsigned' => true),
        'created'              => array('type' => 'integer', 'null' => true, 'default' => null, 'unsigned' => true),
    ...
    public $topics = array(
        ...
        'creator_user_id' => array(
            ...
            'unsigned' => true,
            'key'      => 'index',
            'comment'  => 'UserId as topic creator(belongsTo User Model)'
        ),
        'team_id'         => array(
            'type'     => 'biginteger',
            'null'     => false,
