...
class AttachedFile extends AppModel
{
    ...
    {
        self::$TYPE_FILE[self::TYPE_FILE_IMG]['name'] = __d\('app', "画像");
        self::$TYPE_FILE[self::TYPE_FILE_VIDEO]['name'] = __d\('app', "動画");
        self::$TYPE_FILE[self::TYPE_FILE_DOC]['name'] = __d\('app', "ドキュメント");
    }
