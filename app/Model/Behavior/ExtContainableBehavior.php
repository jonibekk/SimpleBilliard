...
App::uses('SoftDeletableBehavior', 'Model/Behavior');

/**
 * Cake純正のContainableBehaviorをSoftDeletable用に拡張
 * Class ExtContainableBehavior
 */
class ExtContainableBehavior extends ContainableBehavior
{
     ...
     * @return mixed
     */
    private function _addSoftDeleteConditionForModel($model_name, $children)
    {
