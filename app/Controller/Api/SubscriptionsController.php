...
class SubscriptionsController extends BasePagingController
{
    public function post_addSubscription()
    {
        ...
        try {
            ...
            $res = $SubscriptionService->updateSubscription($user_id, $subscription);
        } catch (Exception $e) {
    ...
    public function post_deleteSubscription()
    {
        ...
        try {
            $user_id = $this->getUserId();
            $subscription = $requestData;
            $res = $SubscriptionService->delete($user_id, $subscription);
        } catch (Exception $e) {
    ...
    public function post_sendNotification()
    {
        ...
        $user_id = $this->getUserId();
        $subscriptions = $SubscriptionService->getSubscriptionByUserId($user_id);
