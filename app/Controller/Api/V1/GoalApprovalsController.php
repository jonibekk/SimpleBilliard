...
class GoalApprovalsController extends ApiController
{
    ...
    function get_list()
    {
        ...
        if (!$this->Team->EvaluationSetting->isEnabled()) {
            ...
            // $this->Notification->outError(__("You don't have access right to this page."));
    ...
    function post_set_as_target()
    {
        ...
        // IDが存在しない場合はNotFound
        if (!$goalMemberId) {
            $this->Notification->outError(__("Ooops, Not Found."));
        ...
        // リストページに表示する通知カード
        $this->Notification->outSuccess(__("Set as target"));
    ...
    function post_remove_from_target()
    {
        ...
        // リストページに表示する通知カード
        $this->Notification->outSuccess(__("Removed from target"));
    ...
    public function post_withdraw()
    {
        ...
        // リストページに表示する通知カード
        $this->Notification->outSuccess(__("Has withdrawn"));
